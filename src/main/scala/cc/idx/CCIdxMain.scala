...
object TestExtract {
    ...
    def main(args: Array[String]): Unit = {
        ...
        IndexUtil.write(wordCount_df, "s3a://maria-1086/Brian_Testing" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyyMMdd_HHmmss")), include_header=true, num_files=1)
/*
        /**
